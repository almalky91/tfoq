...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* ABOUT */}
      <section id="about" className="py-14 sm:py-16 md:py-20 bg-background scroll-mt-20">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
            <span className="t-eyebrow text-primary">{about.eyebrow}</span>
            <h2 className="t-h1 text-foreground mt-2 sm:mt-3">{about.title}</h2>
            <p className="t-body text-muted-foreground mt-4 sm:mt-5 leading-loose whitespace-pre-line">{about.body}</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 max-w-4xl mx-auto">
              {about.mission && (
                <div className="group rounded-2xl bg-card border border-border p-6 sm:p-7 shadow-card hover:shadow-elegant hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="t-h3 text-foreground mb-2">رسالتنا</h3>
                  <p className="t-small text-muted-foreground leading-relaxed whitespace-pre-line">{about.mission}</p>
                </div>
              )}
              {about.vision && (
                <div className="group rounded-2xl bg-card border border-border p-6 sm:p-7 shadow-card hover:shadow-elegant hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="t-h3 text-foreground mb-2">رؤيتنا</h3>
                  <p className="t-small text-muted-foreground leading-relaxed whitespace-pre-line">{about.vision}</p>
                </div>
              )}
            </div>
          )}
